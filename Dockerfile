...
RUN sed -i 's/MYSQL_IP = "127.0.0.1"/MYSQL_IP = "192.168.133.78"/g' /home/ebotv3/ebot-csgo/config/config.ini

RUN sed -i 's/127.0.0.1/192.168.133.78/g' /home/ebotv3/ebot-csgo/config/config.ini
