...
RUN mkdir ${homedir} && curl -L https://github.com/deStrO/eBot-CSGO/archive/v3.1-threads.zip >> ${homedir}/master.zip && unzip -d ${homedir} ${homedir}/master.zip && ln -s ${homedir}/eBot-CSGO-master ${homedir}/ebot-csgo && cd ${homedir}/ebot-csgo && /usr/bin/php /usr/bin/composer.phar install
